...
| Q-08 | Importierte oder migrierte Settings aktivieren nie automatisch Input- oder AX-Module. **Eine benannte Ausnahme, entschieden 2026-08-14**: die Creator's Settings duerfen `hyperKeyEnabled` setzen. Sie sind kein Import, sondern eine ausdrueckliche Uebernahme hinter einer bestaetigten Zusammenfassung, und ohne Hyperkey sind die beiden Shortcut-Presets desselben Satzes unbenutzbar. Bedingung: die Zusammenfassung benennt die Caps-Lock-Umbelegung in einem eigenen Satz. Fuer Import, Migration und jeden anderen Pfad gilt die Regel unveraendert | Verhindert unbeabsichtigtes Scharfschalten nach Settings-Uebernahme |
