...
- Befund vom 2026-07-27 aus der Mausbedienung: bei grossen Spruengen flackerte der Bildschirm, weil jeder Swipe ein echter Space-Wechsel ist. Der Versuch, das ueber `CGSManagedDisplaySetCurrentSpace` zu umgehen, wurde am 2026-07-27 am Zielgeraet verworfen: der Wechsel war zwar sofort und flackerfrei, legte aber die Fenster des Ziel-Space ueber den sichtbaren, statt zu wechseln, und beschaedigte auch die native Space-Auswahl in Mission Control, bis der Dock neu gestartet wurde. Das Flackern bleibt damit systembedingt; nur `stepInterval` verkuerzt die sichtbare Dauer.
