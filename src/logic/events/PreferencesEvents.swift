...
class PreferencesEvents {
    ...
    static func preferenceChanged(_ key: String) {
        ...
        case "inputModulesSafeMode": KeyboardEvents.inputSafeModeChanged(); TypingMute.preferenceChanged()
        ...
        case "typingMuteEnabled", "typingMuteHoldMs": TypingMute.preferenceChanged()
