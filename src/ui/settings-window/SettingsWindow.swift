...
class SettingsWindow: NSWindow {
    ...
    private func sectionDefinitions() -> [SettingsSectionDefinition] {
        [
            ...
            SettingsSectionDefinition(id: "menubar-menu", title: NSLocalizedString("Menu Bar Menu", comment: ""), description: NSLocalizedString("Choose which groups and entries the menubar menu shows, and assign shortcuts to its actions.", comment: ""), imageName: "controls", systemSymbolName: "menubar.rectangle", view: MenuBarMenuTab.initTab()),
